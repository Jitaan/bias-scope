...
def cluster_articles(articles: list[Article]) -> dict:
    ...
    print('articles 1st dropna ', len(df))
    ...
    print('articles 2nd dropna ', len(df))
    ...
    print('articles dupes drop', len(df))

    df = df.reset_index(drop=True)

    if len(df) == 0:
        print('not articles 2.0')
        return {
            "articles": [],
            "events": []
        }
    ...
    print('articles thisistheend1', len(df))
    ...
    print('articles thisistheend2', len(processed_articles))
